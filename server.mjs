      ...
      const coachProtocolCoverage = (() => {
        ...
        if (ctx.routine.length > 0) {
          ...
          return {
            ...
            mechanical:    r.some((s) => s.includes('massage') || s.includes('dermaroller') || s.includes('derma roller') || s.includes('derma stamp') || s.includes('dermastamp') || s.includes('dermapen') || s.includes('microneedl') || s.includes('micro-needl') || s.includes('dr pen') || s.includes('drpen') || s.includes('dr.pen') || s.includes('zgts') || s.includes('derminator') || s.includes('lllt') || s.includes('laser cap') || s.includes('laser comb') || s.includes('laser helmet') || s.includes('laserband') || s.includes('laser band') || s.includes('capillus') || s.includes('hairmax') || s.includes('irestore') || s.includes('igrow') || s.includes('theradome') || s.includes('kiierr') || s.includes('illumiflow')),
            ...
            lllt:          r.some((s) => s.includes('lllt') || s.includes('laser cap') || s.includes('laser comb') || s.includes('laser helmet') || s.includes('laserband') || s.includes('laser band') || s.includes('capillus') || s.includes('hairmax') || s.includes('irestore') || s.includes('igrow') || s.includes('theradome') || s.includes('kiierr') || s.includes('illumiflow')),
