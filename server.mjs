      ...
      const protocolStatusLine = (() => {
        ...
        if (!pc && ctx.routine.length > 0) {
          ...
          pc = {
            ...
            rx:          r.some((s) => s.includes('finasteride') || s.includes('propecia') || s.includes('dutasteride') || s.includes('avodart') || s.includes('proscar') || s.includes('finpecia') || s.includes('spironolactone') || s.includes('spiro') || s.includes('aldactone') || s.includes('bicalutamide') || s.includes('flutamide') || s.includes('cyproterone') || s.includes('androcur')),
