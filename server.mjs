...
- crown: 100 = full vertex/crown coverage from above. Stage-correlated ranges: NW1→90-100, NW2→87-100, NW3→82-97 (crown should be intact unless NW3v), NW3v→55-75 (early vertex thinning distinguishes this stage), NW4→35-58, NW5→18-40, NW6→5-20 (crown fully merged with frontal zone; essentially no vertex coverage), NW7→2-12 (complete vertex absence; only narrow horseshoe fringe survives). If crown IS visible in the photo, score directly from what you see. If not, use the stage estimate.
