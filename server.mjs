                ...
                : data.stage === 'NW4'
                  ...
                  : (data.stage === 'diffuse' || data.stage === 'n/a (female)')
                    ...
                    ? (_hasFinasteride && _hasDHTShampoo && _hasSupplements
                        ...
                        : _hasFinasteride && _hasDHTShampoo
                          ? 'Finasteride + DHT-blocking shampoo delivers dual-level DHT prevention at NW1 where mid-scalp density is fully intact — the strongest preventive pair available. Add a supplement stack (biotin, zinc, vitamin D) to complete the protocol; nutritional support forms the strongest three-layer non-Rx preventive foundation for long-term density. Take monthly overhead photos to catch any early mid-scalp change the moment it begins.'
