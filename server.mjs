    ...
    try {
      ...
      const systemPrompt = [
        ...
        ctx.scan?.photoNote && ctx.scan.photoQuality !== 'poor'
          ? `- Scan clinical note: ${ctx.scan.photoNote} — if this note flags a non-AGA condition (FFA, alopecia areata, DUPA, traction alopecia, CCCA, seborrheic dermatitis, scalp psoriasis), follow the Non-AGA condition handling instructions above.`
          : '',
