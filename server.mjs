    ...
    try {
      ...
      const systemPrompt = [
        ...
        ctx.scan?.photoQuality && ctx.scan.photoQuality !== 'good'
          ...
          : '',
        ctx.scan?.photoNote && ctx.scan.photoQuality === 'good'
          ? `- Scan clinical note: ${ctx.scan.photoNote} — if this note flags a non-AGA condition (FFA, alopecia areata, DUPA, traction alopecia, seborrheic dermatitis, scalp psoriasis), follow the Non-AGA condition handling instructions above.`
          : '',
