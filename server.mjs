    ...
    try {
      ...
      const systemPrompt = [
        ...
        ctx.scan?.photoNote && ctx.scan.photoQuality === 'good'
          ? `- Scan clinical note: ${ctx.scan.photoNote} — if this note flags a non-AGA condition (FFA, alopecia areata, DUPA, traction alopecia), follow the Non-AGA condition handling instructions above.`
          : '',
