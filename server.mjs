                                        ...
                                        : _hasMinoxidil
                                            ...
                                            : _hasDHTShampoo && _hasMassage
                                                ...
                                                : _hasDHTShampoo
                                                    ? (_hasSupplements
                                                        ? (data.stage === 'NW3v'
                                                            ? 'Your supplement stack and DHT-blocking shampoo cover nutritional support and topical DHT suppression at NW3v where mid-scalp and early crown density are both declining — leave DHT shampoo on 3-5 minutes per wash 3× weekly and keep supplements consistent. Add minoxidil applied to both zones twice daily as the topical growth signal; supplements + DHT shampoo + minoxidil is the strongest OTC three-layer density approach for the dual active zone at NW3v. Track with monthly overhead photos.'
